...
<head>
    ...
    <link href="http://fonts.cdnfonts.com/css/beckman" rel="stylesheet">
...
<body>
    <div class="container-lg">
        <nav class="navbar navbar-expand-lg navbar-light ">
            ...
            <a class="nav-item nav-link mob"> <img src="/img/cart.svg" alt=""> </a>
            <a class="nav-item nav-link mob"> <img src="/img/layers.svg" alt=""></a>


            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation" style="margin-top: 20px;">
            ...
            <div class="" style="width: 100%;">
                <div class="collapse navbar-collapse d-lg-flex justify-content-between" id="navbarTogglerDemo01">
                    <ul class="navbar-nav ">
                        ...
                        <a class="nav-item nav-link">  Categories</a>
